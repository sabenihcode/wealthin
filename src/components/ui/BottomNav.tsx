          ...
          return (
            <div key={key} className="relative -mt-10">
              <button
                ...
                className="w-14 h-14 bg-gradient-to-br from-sage-500
                           to-emerald-500 hover:opacity-90 text-white
                           rounded-full flex items-center justify-center
                           shadow-lg shadow-sage-500/30
                           hover:shadow-sage-500/40
