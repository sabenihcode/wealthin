...
export function TransaksiPage(): JSX.Element {
  ...
  const grouped = useMemo<Record<string, Transaction[]>>(() => {
    ...
    filtered.forEach(t => {
      // Ambil bagian tanggal sebelum koma ("Hari ini", "Kemarin", "2 Jun 2025")
  ...
  return (
    <div className="animate-fade-in space-y-5 pt-6">
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-5
        ...
        <div className="absolute -top-8 -right-8 w-32 h-32 bg-blue-500 
                        rounded-full filter blur-[60px] opacity-20 
                        pointer-events-none" />
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-slate-900 border border-slate-800 
                     rounded-2xl py-3.5 pl-11 pr-4 text-xs 
                     font-semibold text-white placeholder-slate-600
        ...
        <div className="space-y-6">
          {Object.entries(grouped).map(([dateLabel, txs]) => (
            <div key={dateLabel}>
              ...
              {/* Card berisi list transaksi */}
              <div className="bg-slate-900 border border-slate-800 
                              rounded-3xl p-4 divide-y divide-slate-800/50">
                {txs.map(t => (
